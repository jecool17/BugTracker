...
namespace BugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,TicketId,Comment,Created")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,TicketId,Comment,Created")] TicketComment ticketComment)
        {
            if (ModelState.IsValid)
            {
